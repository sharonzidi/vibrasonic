...
int  oct_bias[] = { 100, 100, 100, 100, 100, 100, 100, 50};
...
//     Serial.println("");
      ...
      frequencyGraph(fht_oct_out[1] - oct_bias[1], fht_oct_out[3] - oct_bias[3], fht_oct_out[5] - oct_bias[5] , fht_oct_out[7] - oct_bias[7]);
    }
